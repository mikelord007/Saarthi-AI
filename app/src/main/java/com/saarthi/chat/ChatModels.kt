...
/** Why a task stopped without finishing — [IRREVERSIBLE_GUARD] gets History's "handed back at" note and the hand-back card; anything else is a plain stop/failure note. */
enum class BlockCause { IRREVERSIBLE_GUARD, OTHER }
